...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="w-full bg-white text-slate-900 min-h-[70vh] flex items-center justify-center px-4 sm:px-6 lg:px-8" style={GIL_SANS}>
      <div className="text-center max-w-md mx-auto py-12 sm:py-16">

        {/* Error Code */}
        <div className="mb-6 sm:mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 rounded-2xl bg-red-50 mb-4">
        ...
        {/* Quick Links */}
        <div className="card-subtle p-6 mb-6 sm:mb-8">
          <p className="text-xs font-medium text-slate-700 mb-4">Or explore our main sections:</p>
