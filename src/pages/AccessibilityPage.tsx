    ...
    <div className="w-full bg-white text-slate-900 pt-6 sm:pt-8 pb-16" style={GIL_SANS}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 sm:mb-6 flex items-center gap-2 text-xs sm:text-sm text-slate-400">
          ...
          <span>/</span>
          <span className="text-slate-700 font-medium">Accessibility</span>
        </div>
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
          ...
          <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-3 text-xs">
            <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full font-medium">{conformanceTarget}</span>
            <span className="px-3 py-1 bg-slate-100 text-slate-700 rounded-full">{conformanceStatus}</span>
