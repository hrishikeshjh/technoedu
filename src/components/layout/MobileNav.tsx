...
export const MobileNav: React.FC = () => {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-t border-slate-200/90 pt-1.5 pb-[max(0.5rem,env(safe-area-inset-bottom))] px-2 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex flex-col items-center justify-center py-1 px-2.5 rounded-xl text-[10px] transition-all no-min-touch ${
                  isActive
                    ? 'text-brand-red font-bold bg-red-50/80 scale-105'
